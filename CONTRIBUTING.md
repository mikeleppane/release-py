# Contributing to release-py

Thank you for your interest in contributing to release-py! This document provides
...
BREAKING CHANGE: The [tool.release-py.version] section has been renamed
to [tool.release-py.versioning]."
...
Releases are automated using release-py itself! When changes are merged to `main`:
...
Thank you for contributing to release-py!
